...
# Его можно найти в документации метода [upload()]
# (https://www.dropbox.com/developers/documentation/http/documentation#files-upload).
UPLOAD_LINK = 'https://content.dropboxapi.com/2/files/upload'
# Эндпоинт для создания ссылки на изображение.
# Его можно найти в документации метода [create_shared_link_with_settings()]
...
# Добавьте новые импорты к списку импортов.
import asyncio
import aiohttp
import json
